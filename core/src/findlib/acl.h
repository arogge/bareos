...
static constexpr uint32_t ACL_REPORT_ERR_MAX_PER_JOB = 25;
...
static constexpr uint32_t BACL_FLAG_SAVE_NATIVE = 0x01;
static constexpr uint32_t BACL_FLAG_SAVE_AFS = 0x02;
static constexpr uint32_t BACL_FLAG_RESTORE_NATIVE = 0x04;
static constexpr uint32_t BACL_FLAG_RESTORE_AFS = 0x08;
